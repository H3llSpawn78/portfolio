...
<style>
.main-logo{
    filter: drop-shadow(0px 1px 6px lime);
    display: flex;
    align-self: center;
...
.main-logo:hover{
filter: drop-shadow(0px 1px 10px lime);
}
</style>